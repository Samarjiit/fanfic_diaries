...
function connection() {
  ...
  // xhr.setRequest Header("X-Requested-With", "XMLHttpRequest");
...
function comics(characterID) {
  ...
  xhr.onloadend = function() {
    document.getElementById("comicsSpinnerSection").innerHTML =
      '<strong id="spinnerText class="text-success">Done.</Stong>';
  };
  xhr.send();
}
...
function singleComic() {
  ...
  xhr.onload = function() {
    if (this.status == 200) {
      ...
      output +=
        '<h1 class="header-main-titles single-comic__main-title">' +
        comicInfo.title +
        "</h1>" +
        '<div class="card mb-3">' +
...
function comicCreator() {
  ...
  xhr.onload = function() {
    if (this.status == 200) {
      ...
      output +=
        '<h1 class="header-main-titles single-comic__main-title">Creator</h1>' +
        '<div class="card mb-3">' +
        '<div class="row no-gutters">' +
        '<div class="col-md-4">' +
        '<img src="' +
      ...
      output +=
        '<h1 class="header-main-titlesgit  single-comic__main-title">Comics</h1>' +
