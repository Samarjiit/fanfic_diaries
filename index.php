...
<html lang="en">
  <head>
    ...
    />
    <title>Fanfic diaries</title>
    <link rel="stylesheet" href="style.css" />
  </head>
  <body onload="character()">
    <div class="jumbotron">
      <div class="container">
        <h1 class="header-main-title">Fanfic diaries</h1>
        <form id="connectionForm">
          <div class="form-group">
            <input
              ...
              name="name"
              id="name"
              class="form-control character-search-box"
          ...
          <input
            type="submit"
            value="Search!"
            class="btn btn-danger mb-2 float-right search-character-button"
          />
        </form>
      </div>
    </div>
